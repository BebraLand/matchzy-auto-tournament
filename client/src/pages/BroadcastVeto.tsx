...
const broadcastStyles = `
  ...
  .map-info p { max-width:100%; min-height:2.5em; margin:0; display:flex; align-items:flex-end; color:#f4f7fb; font-size:clamp(9px,.66vw,13px); letter-spacing:.08em; font-weight:850; line-height:1.25; text-shadow:0 2px 7px rgba(0,0,0,.8); }
