...
import { VetoDesignCanvas, defaultVetoDesign, previewVeto, type VetoBinding, type VetoDesign, type VetoElement, type VetoElementKind, type VetoMapMetadata, type VetoScreen } from '../components/veto/VetoDesignCanvas';
