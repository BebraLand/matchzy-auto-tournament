...
assert.equal(design.mapStateStyle, 'outline');
assert.equal(design.mapStateTintOpacity, 0.14);
...
assert.equal(validDesign({ ...design, mapStateStyle: 'tint' }), true);
assert.equal(validDesign({ ...design, mapStateStyle: 'invalid' }), false);
assert.equal(validDesign({ ...design, mapStateStyle: 'tint', mapStateTintOpacity: 0.28 }), true);
assert.equal(validDesign({ ...design, mapStateTintOpacity: 0.41 }), false);
